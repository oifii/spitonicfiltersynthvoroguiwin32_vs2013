...
#include "stdafx.h"
#include "spitonicfiltersynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitonicfiltersynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitonicfiltersynthvoroguiwin32class"};				// the main window class name
